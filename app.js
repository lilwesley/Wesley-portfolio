...
window.addEventListener("scroll", () => {
  ...
  authorName.style.backgroundPositionY = `${offsetY * 0.5}px`;
  ...
  phone [0].style.transform = `translateX(calc(450vh - ${offsetY}px))`;
  laptop.style.transform = `translateX(calc(570vh - ${offsetY}px))`;
  phone [1].style.transform = `translateX(calc(700vh - ${offsetY}px))`;
});
